...
fn test_format_duration() {
    ...
    assert_eq!(
        format_duration(Duration::days(2) + Duration::hours(12) + Duration::minutes(30)),
        "2d12h"
    );
    ...
    assert_eq!(
        format_duration(Duration::seconds(5) + Duration::milliseconds(250)),
        "5.25s"
    );
    assert_eq!(
        format_duration(Duration::seconds(60) + Duration::milliseconds(750)),
        "1m0s"
    );
}
